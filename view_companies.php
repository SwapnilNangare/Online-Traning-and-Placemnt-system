    ...
    <div class="container-fluid ">    
        <div class="row content">
            ...
            <div class="col-sm-10 text-left" style="padding-left:40px;padding-right:40px;">
                <h1 class="text-center"><b>Recruiters List</b></h1>
                <br>
                <div class="panel panel-default">
                    <div class="panel-heading" id="load123">
                        <b>  Registered Recruiters</b>
...
#
                                    ...
                                    foreach ($result as $row) {
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php echo $row->salary; ?></td>
                                             <td><?php  if(date($row->deadline) >= date('Y-m-d', strtotime('today'))){echo "Active";}
                                             else{ echo "Inactive"; }; ?></td>
                                             <td><a href="<?php echo $row->reg_link;?>" class="btn btn-info">Register</a></td>
                                        </tr>
                                        <?php
                                        $count = $count + 1;
                                    }
    ...
    <h4>NOTE: The site is under development and the data may be fictitious.</h4>
